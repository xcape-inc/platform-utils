...
BOOTLOADER_DEVICE_PATH="${DEVICE_PATH}${BOOTLOADER_DEVICE_NUMBER}"
BOOT_DEVICE_NUMBER=${BOOT_DEVICE_NUMBER:-1}
BOOT_DEVICE_PATH="${DEVICE_PATH}${BOOT_DEVICE_NUMBER}"
ROOT_DEVICE_NUMBER=${ROOT_DEVICE_NUMBER:-2}
ROOT_DEVICE_PATH="${DEVICE_PATH}${ROOT_DEVICE_NUMBER}"
